...
urlpatterns = [
    path('login/', auth_views.LoginView.as_view(template_name='core/p_login.html', redirect_authenticated_user=True), name='login'),
    ...
    path("api/anilist_search/", views.anilist_search, name="anilist_search"),
    ...
    path('igdb/game/<str:igdb_id>/', views.igdb_detail, name='igdb_detail'),
    ...
    path('settings/refresh-data/', views.refresh_data, name='refresh_data'),
    ...
    path('backup/cancel/<str:task_id>/', views.backup_cancel, name='backup_cancel'),
    path('backup/download/<str:task_id>/', views.backup_download, name='backup_download'),
    ...
    path('api/game_screenshots/', views.game_screenshots_api, name='game_screenshots_api'),
    ...
    path('person/<str:person_type>/<str:person_id>/', views.person_detail, name='person_detail'),
    path('api/actor/<str:actor_id>/', views.actor_detail_api, name='actor_detail_api'),
    path('api/character/<str:character_id>/', views.character_detail_api, name='character_detail_api'),
    ...
    path('api/calendar/search-local/', views.calendar_search_local_items, name='calendar_search_local'),
    path('api/calendar/add/', views.add_custom_event, name='calendar_add_event'),
    path('api/calendar/delete/<int:event_id>/', views.delete_calendar_event, name='calendar_delete_event'),
    path('api/calendar/sync/', views.sync_calendar, name='calendar_sync'),
    path('api/calendar/toggle-notify/<int:event_id>/', views.toggle_calendar_notify, name='calendar_toggle_notify'),
    path('api/calendar/dismiss-notify/<int:event_id>/', views.dismiss_calendar_notify, name='calendar_dismiss_notify'),
